...
export const translations = {
  he: {
    ...
    downloadAllFlat: 'הורד את כל הקבצים (ZIP)',
    downloadFlat: 'הורד ללא תיקיות',
    downloadOrganized: 'הורד עם תיקיות',
    openFile: 'פתח קובץ',
  ...
  en: {
    ...
    downloadAllFlat: 'Download All Files (ZIP)',
    downloadFlat: 'Download (No Folders)',
    downloadOrganized: 'Download (With Folders)',
    openFile: 'Open File',
